...
public class CommunityAccountDao {
     ...
     * @author SwordPlayer
     */
    public byte doesPassVerification(String mobile) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        byte state = -1;
     ...
     * @author SwordPlayer
     */
    public CommunityAccount getCommunityAccountInfo(String mobile){
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
     ...
     * @author SwordPlayer
     */
    public ArrayList<Department> getDepartmentInfo(int community_id){
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try{
            ...
            while(rs.next()){
                ...
                String departmentDes = rs.getString("department_des");
                String departmentName = rs.getString("department_name");
                Date createAt = new Date(rs.getTimestamp("create_at").getTime());
                Department department = new Department(id, departmentId, communityId, departmentDes, departmentName, createAt);
